...
public abstract class ReplaceOperatorAssignmentWithAssignmentIntentionTest extends IPPTestCase {
    public void testOperatorAssignment1() {
        doTest();
    }

    public void testDoubleOpAssign() {
        doTest();
    }

    public void testStringOpAssign() {
        doTest();
    }

    public void testByteOpAssign() {
        doTest();
    }
    ...
    public void testPolyadicAssignment() {
        doTest(IntentionPowerPackLocalize.replaceOperatorAssignmentWithAssignmentIntentionName("*=").get());
    }
