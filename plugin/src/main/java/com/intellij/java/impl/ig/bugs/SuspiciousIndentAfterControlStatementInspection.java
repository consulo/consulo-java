...
public class SuspiciousIndentAfterControlStatementInspection extends BaseInspection {
    ...
    public LocalizeValue getDisplayName() {
        return InspectionGadgetsLocalize.suspiciousIndentAfterControlStatementDisplayName();
    }

    @Override
    @Nonnull
    protected String buildErrorString(Object... infos) {
        return InspectionGadgetsLocalize.suspiciousIndentAfterControlStatementProblemDescriptor().get();
    }
    ...
    private static class SuspiciousIndentAfterControlStatementVisitor
        ...
        private static boolean isWhitespaceSuspicious(
