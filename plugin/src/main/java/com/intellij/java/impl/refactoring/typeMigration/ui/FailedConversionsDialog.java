...
public class FailedConversionsDialog extends DialogWrapper {
    private final LocalizeValue[] myConflictDescriptions;
    public static final int VIEW_USAGES_EXIT_CODE = NEXT_USER_EXIT_CODE;

    public FailedConversionsDialog(LocalizeValue[] conflictDescriptions, Project project) {
        super(project, true);
        myConflictDescriptions = conflictDescriptions;
        setTitle(RefactoringLocalize.usagesDetectedTitle());
        setOKButtonText(RefactoringLocalize.ignoreButton());
    ...
    protected JComponent createCenterPanel() {
        ...
        JEditorPane messagePane = new JEditorPane(UIUtil.HTML_MIME, "");
