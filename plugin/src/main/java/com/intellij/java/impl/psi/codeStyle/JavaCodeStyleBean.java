...
import consulo.language.codeStyle.BraceStyle;
...
public class JavaCodeStyleBean extends CodeStyleBean {
    ...
    public void setIndent(int value) {
        getIndentOptions(true).INDENT_SIZE = value;
    }
    ...
    public void setContinuationIndent(int value) {
        getIndentOptions(true).CONTINUATION_INDENT_SIZE = value;
    }
    ...
    public void setTabSize(int value) {
        getIndentOptions(true).TAB_SIZE = value;
    }
    ...
    public void setUseTabCharacter(boolean value) {
        getIndentOptions(true).USE_TAB_CHARACTER = value;
    }
    ...
    public void setSmartTabs(boolean value) {
        getIndentOptions(true).SMART_TABS = value;
    }
    ...
    public void setKeepIndentsOnEmptyLines(boolean value) {
        getIndentOptions(true).KEEP_INDENTS_ON_EMPTY_LINES = value;
    }
    ...
    public void setLineCommentAtFirstColumn(boolean value) {
        getCommonSettings().LINE_COMMENT_AT_FIRST_COLUMN = value;
    }
    ...
    public void setBlockCommentAtFirstColumn(boolean value) {
        getCommonSettings().BLOCK_COMMENT_AT_FIRST_COLUMN = value;
    }
    ...
    public void setLineCommentAddSpace(boolean value) {
        getCommonSettings().LINE_COMMENT_ADD_SPACE = value;
    }
    ...
    public void setKeepLineBreaks(boolean value) {
        getCommonSettings().KEEP_LINE_BREAKS = value;
    }
    ...
    public void setKeepFirstColumnComment(boolean value) {
        getCommonSettings().KEEP_FIRST_COLUMN_COMMENT = value;
    }
    ...
    public void setKeepControlStatementInOneLine(boolean value) {
        getCommonSettings().KEEP_CONTROL_STATEMENT_IN_ONE_LINE = value;
    }
    ...
    public void setKeepBlankLinesInDeclarations(int value) {
        getCommonSettings().KEEP_BLANK_LINES_IN_DECLARATIONS = value;
    }
    ...
    public void setKeepBlankLinesInCode(int value) {
        getCommonSettings().KEEP_BLANK_LINES_IN_CODE = value;
    }
    ...
    public void setKeepBlankLinesBeforeRightBrace(int value) {
        getCommonSettings().KEEP_BLANK_LINES_BEFORE_RBRACE = value;
    }
    ...
    public void setBlankLinesBeforePackage(int value) {
        getCommonSettings().BLANK_LINES_BEFORE_PACKAGE = value;
    }
    ...
    public void setBlankLinesAfterPackage(int value) {
        getCommonSettings().BLANK_LINES_AFTER_PACKAGE = value;
    }
    ...
    public void setBlankLinesBeforeImports(int value) {
        getCommonSettings().BLANK_LINES_BEFORE_IMPORTS = value;
    }
    ...
    public void setBlankLinesAfterImports(int value) {
        getCommonSettings().BLANK_LINES_AFTER_IMPORTS = value;
    }
    ...
    public void setBlankLinesAroundClass(int value) {
        getCommonSettings().BLANK_LINES_AROUND_CLASS = value;
    }
    ...
    public void setBlankLinesAroundField(int value) {
        getCommonSettings().BLANK_LINES_AROUND_FIELD = value;
    }
    ...
    public void setBlankLinesAroundMethod(int value) {
        getCommonSettings().BLANK_LINES_AROUND_METHOD = value;
    }
    ...
    public void setBlankLinesBeforeMethodBody(int value) {
        getCommonSettings().BLANK_LINES_BEFORE_METHOD_BODY = value;
    }
    ...
    public void setBlankLinesAroundFieldInInterface(int value) {
        getCommonSettings().BLANK_LINES_AROUND_FIELD_IN_INTERFACE = value;
    }
    ...
    public void setBlankLinesAroundMethodInInterface(int value) {
        getCommonSettings().BLANK_LINES_AROUND_METHOD_IN_INTERFACE = value;
    }
    ...
    public void setBlankLinesAfterClassHeader(int value) {
        getCommonSettings().BLANK_LINES_AFTER_CLASS_HEADER = value;
    }
    ...
    public void setBlankLinesAfterAnonymousClassHeader(int value) {
        getCommonSettings().BLANK_LINES_AFTER_ANONYMOUS_CLASS_HEADER = value;
    }
    ...
    public void setBlankLinesBeforeClassEnd(int value) {
        getCommonSettings().BLANK_LINES_BEFORE_CLASS_END = value;
    }
    ...
    public void setClassBraceStyle(BraceStyle value) {
        getCommonSettings().CLASS_BRACE_STYLE = value.intValue();
    }
    ...
    public void setMethodBraceStyle(BraceStyle value) {
        getCommonSettings().METHOD_BRACE_STYLE = value.intValue();
    }
    ...
    public void setLambdaBraceStyle(BraceStyle value) {
        getCommonSettings().LAMBDA_BRACE_STYLE = value.intValue();
    }
    ...
    public void setDoNotIndentTopLevelClassMembers(boolean value) {
        getCommonSettings().DO_NOT_INDENT_TOP_LEVEL_CLASS_MEMBERS = value;
    }
    ...
    public void setElseOnNewLine(boolean value) {
        getCommonSettings().ELSE_ON_NEW_LINE = value;
    }
    ...
    public void setWhileOnNewLine(boolean value) {
        getCommonSettings().WHILE_ON_NEW_LINE = value;
    }
    ...
    public void setCatchOnNewLine(boolean value) {
        getCommonSettings().CATCH_ON_NEW_LINE = value;
    }
    ...
    public void setFinallyOnNewLine(boolean value) {
        getCommonSettings().FINALLY_ON_NEW_LINE = value;
    }
    ...
    public void setIndentCaseFromSwitch(boolean value) {
        getCommonSettings().INDENT_CASE_FROM_SWITCH = value;
    }
    ...
    public void setCaseStatementOnNewLine(boolean value) {
        getCommonSettings().CASE_STATEMENT_ON_NEW_LINE = value;
    }
    ...
    public void setSpecialElseIfTreatment(boolean value) {
        getCommonSettings().SPECIAL_ELSE_IF_TREATMENT = value;
    }
    ...
    public void setAlignMultilineChainedMethods(boolean value) {
        getCommonSettings().ALIGN_MULTILINE_CHAINED_METHODS = value;
    }
    ...
    public void setAlignMultilineParameters(boolean value) {
        getCommonSettings().ALIGN_MULTILINE_PARAMETERS = value;
    }
    ...
    public void setAlignMultilineParametersInCalls(boolean value) {
        getCommonSettings().ALIGN_MULTILINE_PARAMETERS_IN_CALLS = value;
    }
    ...
    public void setAlignMultilineResources(boolean value) {
        getCommonSettings().ALIGN_MULTILINE_RESOURCES = value;
    }
    ...
    public void setAlignMultilineFor(boolean value) {
        getCommonSettings().ALIGN_MULTILINE_FOR = value;
    }
    ...
    public void setAlignMultilineBinaryOperation(boolean value) {
        getCommonSettings().ALIGN_MULTILINE_BINARY_OPERATION = value;
    }
    ...
    public void setAlignMultilineAssignment(boolean value) {
        getCommonSettings().ALIGN_MULTILINE_ASSIGNMENT = value;
    }
    ...
    public void setAlignMultilineTernaryOperation(boolean value) {
        getCommonSettings().ALIGN_MULTILINE_TERNARY_OPERATION = value;
    }
    ...
    public void setAlignMultilineThrowsList(boolean value) {
        getCommonSettings().ALIGN_MULTILINE_THROWS_LIST = value;
    }
    ...
    public void setAlignThrowsKeyword(boolean value) {
        getCommonSettings().ALIGN_THROWS_KEYWORD = value;
    }
    ...
    public void setAlignMultilineExtendsList(boolean value) {
        getCommonSettings().ALIGN_MULTILINE_EXTENDS_LIST = value;
    }
    ...
    public void setAlignMultilineMethodBrackets(boolean value) {
        getCommonSettings().ALIGN_MULTILINE_METHOD_BRACKETS = value;
    }
    ...
    public void setAlignGroupFieldDeclarations(boolean value) {
        getCommonSettings().ALIGN_GROUP_FIELD_DECLARATIONS = value;
    }
    ...
    public void setAlignConsecutiveVariableDeclarations(boolean value) {
        getCommonSettings().ALIGN_CONSECUTIVE_VARIABLE_DECLARATIONS = value;
    }
    ...
    public void setAlignSubsequentSimpleMethods(boolean value) {
        getCommonSettings().ALIGN_SUBSEQUENT_SIMPLE_METHODS = value;
    }
    ...
    public void setSpaceAroundAssignmentOperators(boolean value) {
        getCommonSettings().SPACE_AROUND_ASSIGNMENT_OPERATORS = value;
    }
    ...
    public void setSpaceAroundLogicalOperators(boolean value) {
        getCommonSettings().SPACE_AROUND_LOGICAL_OPERATORS = value;
    }
    ...
    public void setSpaceAroundEqualityOperators(boolean value) {
        getCommonSettings().SPACE_AROUND_EQUALITY_OPERATORS = value;
    }
    ...
    public void setSpaceAroundRelationalOperators(boolean value) {
        getCommonSettings().SPACE_AROUND_RELATIONAL_OPERATORS = value;
    }
    ...
    public void setSpaceAroundBitwiseOperators(boolean value) {
        getCommonSettings().SPACE_AROUND_BITWISE_OPERATORS = value;
    }
    ...
    public void setSpaceAroundAdditiveOperators(boolean value) {
        getCommonSettings().SPACE_AROUND_ADDITIVE_OPERATORS = value;
    }
    ...
    public void setSpaceAroundMultiplicativeOperators(boolean value) {
        getCommonSettings().SPACE_AROUND_MULTIPLICATIVE_OPERATORS = value;
    }
    ...
    public void setSpaceAroundShiftOperators(boolean value) {
        getCommonSettings().SPACE_AROUND_SHIFT_OPERATORS = value;
    }
    ...
    public void setSpaceAroundUnaryOperator(boolean value) {
        getCommonSettings().SPACE_AROUND_UNARY_OPERATOR = value;
    }
    ...
    public void setSpaceAroundLambdaArrow(boolean value) {
        getCommonSettings().SPACE_AROUND_LAMBDA_ARROW = value;
    }
    ...
    public void setSpaceAroundMethodRefDblColon(boolean value) {
        getCommonSettings().SPACE_AROUND_METHOD_REF_DBL_COLON = value;
    }
    ...
    public void setSpaceAfterComma(boolean value) {
        getCommonSettings().SPACE_AFTER_COMMA = value;
    }
    ...
    public void setSpaceAfterCommaInTypeArguments(boolean value) {
        getCommonSettings().SPACE_AFTER_COMMA_IN_TYPE_ARGUMENTS = value;
    }
    ...
    public void setSpaceBeforeComma(boolean value) {
        getCommonSettings().SPACE_BEFORE_COMMA = value;
    }
    ...
    public void setSpaceAfterForSemicolon(boolean value) {
        getCommonSettings().SPACE_AFTER_SEMICOLON = value;
    }
    ...
    public void setSpaceBeforeForSemicolon(boolean value) {
        getCommonSettings().SPACE_BEFORE_SEMICOLON = value;
    }
    ...
    public void setSpaceWithinParentheses(boolean value) {
        getCommonSettings().SPACE_WITHIN_PARENTHESES = value;
    }
    ...
    public void setSpaceWithinMethodCallParentheses(boolean value) {
        getCommonSettings().SPACE_WITHIN_METHOD_CALL_PARENTHESES = value;
    }
    ...
    public void setSpaceWithinMethodParentheses(boolean value) {
        getCommonSettings().SPACE_WITHIN_METHOD_PARENTHESES = value;
    }
    ...
    public void setSpaceWithinEmptyMethodParentheses(boolean value) {
        getCommonSettings().SPACE_WITHIN_EMPTY_METHOD_PARENTHESES = value;
    }
    ...
    public void setSpaceWithinIfParentheses(boolean value) {
        getCommonSettings().SPACE_WITHIN_IF_PARENTHESES = value;
    }
    ...
    public void setSpaceWithinWhileParentheses(boolean value) {
        getCommonSettings().SPACE_WITHIN_WHILE_PARENTHESES = value;
    }
    ...
    public void setSpaceWithinForParentheses(boolean value) {
        getCommonSettings().SPACE_WITHIN_FOR_PARENTHESES = value;
    }
    ...
    public void setSpaceWithinTryParentheses(boolean value) {
        getCommonSettings().SPACE_WITHIN_TRY_PARENTHESES = value;
    }
    ...
    public void setSpaceWithinCatchParentheses(boolean value) {
        getCommonSettings().SPACE_WITHIN_CATCH_PARENTHESES = value;
    }
    ...
    public void setSpaceWithinSwitchParentheses(boolean value) {
        getCommonSettings().SPACE_WITHIN_SWITCH_PARENTHESES = value;
    }
    ...
    public void setSpaceWithinSynchronizedParentheses(boolean value) {
        getCommonSettings().SPACE_WITHIN_SYNCHRONIZED_PARENTHESES = value;
    }
    ...
    public void setSpaceWithinCastParentheses(boolean value) {
        getCommonSettings().SPACE_WITHIN_CAST_PARENTHESES = value;
    }
    ...
    public void setSpaceWithinBrackets(boolean value) {
        getCommonSettings().SPACE_WITHIN_BRACKETS = value;
    }
    ...
    public void setSpaceWithinBraces(boolean value) {
        getCommonSettings().SPACE_WITHIN_BRACES = value;
    }
    ...
    public void setSpaceWithinArrayInitializerBraces(boolean value) {
        getCommonSettings().SPACE_WITHIN_ARRAY_INITIALIZER_BRACES = value;
    }
    ...
    public void setSpaceAfterTypeCast(boolean value) {
        getCommonSettings().SPACE_AFTER_TYPE_CAST = value;
    }
    ...
    public void setSpaceBeforeMethodCallParentheses(boolean value) {
        getCommonSettings().SPACE_BEFORE_METHOD_CALL_PARENTHESES = value;
    }
    ...
    public void setSpaceBeforeMethodParentheses(boolean value) {
        getCommonSettings().SPACE_BEFORE_METHOD_PARENTHESES = value;
    }
    ...
    public void setSpaceBeforeIfParentheses(boolean value) {
        getCommonSettings().SPACE_BEFORE_IF_PARENTHESES = value;
    }
    ...
    public void setSpaceBeforeWhileParentheses(boolean value) {
        getCommonSettings().SPACE_BEFORE_WHILE_PARENTHESES = value;
    }
    ...
    public void setSpaceBeforeForParentheses(boolean value) {
        getCommonSettings().SPACE_BEFORE_FOR_PARENTHESES = value;
    }
    ...
    public void setSpaceBeforeTryParentheses(boolean value) {
        getCommonSettings().SPACE_BEFORE_TRY_PARENTHESES = value;
    }
    ...
    public void setSpaceBeforeCatchParentheses(boolean value) {
        getCommonSettings().SPACE_BEFORE_CATCH_PARENTHESES = value;
    }
    ...
    public void setSpaceBeforeSwitchParentheses(boolean value) {
        getCommonSettings().SPACE_BEFORE_SWITCH_PARENTHESES = value;
    }
    ...
    public void setSpaceBeforeSynchronizedParentheses(boolean value) {
        getCommonSettings().SPACE_BEFORE_SYNCHRONIZED_PARENTHESES = value;
    }
    ...
    public void setSpaceBeforeClassLeftBrace(boolean value) {
        getCommonSettings().SPACE_BEFORE_CLASS_LBRACE = value;
    }
    ...
    public void setSpaceBeforeMethodLeftBrace(boolean value) {
        getCommonSettings().SPACE_BEFORE_METHOD_LBRACE = value;
    }
    ...
    public void setSpaceBeforeIfLeftBrace(boolean value) {
        getCommonSettings().SPACE_BEFORE_IF_LBRACE = value;
    }
    ...
    public void setSpaceBeforeElseLeftBrace(boolean value) {
        getCommonSettings().SPACE_BEFORE_ELSE_LBRACE = value;
    }
    ...
    public void setSpaceBeforeWhileLeftBrace(boolean value) {
        getCommonSettings().SPACE_BEFORE_WHILE_LBRACE = value;
    }
    ...
    public void setSpaceBeforeForLeftBrace(boolean value) {
        getCommonSettings().SPACE_BEFORE_FOR_LBRACE = value;
    }
    ...
    public void setSpaceBeforeDoLeftBrace(boolean value) {
        getCommonSettings().SPACE_BEFORE_DO_LBRACE = value;
    }
    ...
    public void setSpaceBeforeSwitchLeftBrace(boolean value) {
        getCommonSettings().SPACE_BEFORE_SWITCH_LBRACE = value;
    }
    ...
    public void setSpaceBeforeTryLeftBrace(boolean value) {
        getCommonSettings().SPACE_BEFORE_TRY_LBRACE = value;
    }
    ...
    public void setSpaceBeforeCatchLeftBrace(boolean value) {
        getCommonSettings().SPACE_BEFORE_CATCH_LBRACE = value;
    }
    ...
    public void setSpaceBeforeFinallyLeftBrace(boolean value) {
        getCommonSettings().SPACE_BEFORE_FINALLY_LBRACE = value;
    }
    ...
    public void setSpaceBeforeSynchronizedLeftBrace(boolean value) {
        getCommonSettings().SPACE_BEFORE_SYNCHRONIZED_LBRACE = value;
    }
    ...
    public void setSpaceBeforeArrayInitializerLeftBrace(boolean value) {
        getCommonSettings().SPACE_BEFORE_ARRAY_INITIALIZER_LBRACE = value;
    }
    ...
    public void setSpaceBeforeElseKeyword(boolean value) {
        getCommonSettings().SPACE_BEFORE_ELSE_KEYWORD = value;
    }
    ...
    public void setSpaceBeforeWhileKeyword(boolean value) {
        getCommonSettings().SPACE_BEFORE_WHILE_KEYWORD = value;
    }
    ...
    public void setSpaceBeforeCatchKeyword(boolean value) {
        getCommonSettings().SPACE_BEFORE_CATCH_KEYWORD = value;
    }
    ...
    public void setSpaceBeforeFinallyKeyword(boolean value) {
        getCommonSettings().SPACE_BEFORE_FINALLY_KEYWORD = value;
    }
    ...
    public void setSpaceBeforeQuest(boolean value) {
        getCommonSettings().SPACE_BEFORE_QUEST = value;
    }
    ...
    public void setSpaceAfterQuest(boolean value) {
        getCommonSettings().SPACE_AFTER_QUEST = value;
    }
    ...
    public void setSpaceBeforeColon(boolean value) {
        getCommonSettings().SPACE_BEFORE_COLON = value;
    }
    ...
    public void setSpaceAfterColon(boolean value) {
        getCommonSettings().SPACE_AFTER_COLON = value;
    }
    ...
    public void setSpaceBeforeTypeParameterList(boolean value) {
        getCommonSettings().SPACE_BEFORE_TYPE_PARAMETER_LIST = value;
    }
    ...
    public void setCallParametersWrap(WrapType value) {
        getCommonSettings().CALL_PARAMETERS_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setPreferParametersWrap(boolean value) {
        getCommonSettings().PREFER_PARAMETERS_WRAP = value;
    }
    ...
    public void setCallParametersLeftParenOnNextLine(boolean value) {
        getCommonSettings().CALL_PARAMETERS_LPAREN_ON_NEXT_LINE = value;
    }
    ...
    public void setCallParametersRightParenOnNextLine(boolean value) {
        getCommonSettings().CALL_PARAMETERS_RPAREN_ON_NEXT_LINE = value;
    }
    ...
    public void setMethodParametersWrap(WrapType value) {
        getCommonSettings().METHOD_PARAMETERS_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setMethodParametersLeftParenOnNextLine(boolean value) {
        getCommonSettings().METHOD_PARAMETERS_LPAREN_ON_NEXT_LINE = value;
    }
    ...
    public void setMethodParametersRightParenOnNextLine(boolean value) {
        getCommonSettings().METHOD_PARAMETERS_RPAREN_ON_NEXT_LINE = value;
    }
    ...
    public void setResourceListWrap(WrapType value) {
        getCommonSettings().RESOURCE_LIST_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setResourceListLeftParenOnNextLine(boolean value) {
        getCommonSettings().RESOURCE_LIST_LPAREN_ON_NEXT_LINE = value;
    }
    ...
    public void setResourceListRightParenOnNextLine(boolean value) {
        getCommonSettings().RESOURCE_LIST_RPAREN_ON_NEXT_LINE = value;
    }
    ...
    public void setExtendsListWrap(WrapType value) {
        getCommonSettings().EXTENDS_LIST_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setThrowsListWrap(WrapType value) {
        getCommonSettings().THROWS_LIST_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setExtendsKeywordWrap(WrapType value) {
        getCommonSettings().EXTENDS_KEYWORD_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setThrowsKeywordWrap(WrapType value) {
        getCommonSettings().THROWS_KEYWORD_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setMethodCallChainWrap(WrapType value) {
        getCommonSettings().METHOD_CALL_CHAIN_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setWrapFirstMethodInCallChain(boolean value) {
        getCommonSettings().WRAP_FIRST_METHOD_IN_CALL_CHAIN = value;
    }
    ...
    public void setParenthesesExpressionLeftParenWrap(boolean value) {
        getCommonSettings().PARENTHESES_EXPRESSION_LPAREN_WRAP = value;
    }
    ...
    public void setParenthesesExpressionRightParenWrap(boolean value) {
        getCommonSettings().PARENTHESES_EXPRESSION_RPAREN_WRAP = value;
    }
    ...
    public void setBinaryOperationWrap(WrapType value) {
        getCommonSettings().BINARY_OPERATION_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setBinaryOperationSignOnNextLine(boolean value) {
        getCommonSettings().BINARY_OPERATION_SIGN_ON_NEXT_LINE = value;
    }
    ...
    public void setTernaryOperationWrap(WrapType value) {
        getCommonSettings().TERNARY_OPERATION_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setTernaryOperationSignsOnNextLine(boolean value) {
        getCommonSettings().TERNARY_OPERATION_SIGNS_ON_NEXT_LINE = value;
    }
    ...
    public void setModifierListWrap(boolean value) {
        getCommonSettings().MODIFIER_LIST_WRAP = value;
    }
    ...
    public void setKeepSimpleBlocksInOneLine(boolean value) {
        getCommonSettings().KEEP_SIMPLE_BLOCKS_IN_ONE_LINE = value;
    }
    ...
    public void setKeepSimpleMethodsInOneLine(boolean value) {
        getCommonSettings().KEEP_SIMPLE_METHODS_IN_ONE_LINE = value;
    }
    ...
    public void setKeepSimpleLambdasInOneLine(boolean value) {
        getCommonSettings().KEEP_SIMPLE_LAMBDAS_IN_ONE_LINE = value;
    }
    ...
    public void setKeepSimpleClassesInOneLine(boolean value) {
        getCommonSettings().KEEP_SIMPLE_CLASSES_IN_ONE_LINE = value;
    }
    ...
    public void setKeepMultipleExpressionsInOneLine(boolean value) {
        getCommonSettings().KEEP_MULTIPLE_EXPRESSIONS_IN_ONE_LINE = value;
    }
    ...
    public void setForStatementWrap(WrapType value) {
        getCommonSettings().FOR_STATEMENT_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setForStatementLeftParenOnNextLine(boolean value) {
        getCommonSettings().FOR_STATEMENT_LPAREN_ON_NEXT_LINE = value;
    }
    ...
    public void setForStatementRightParenOnNextLine(boolean value) {
        getCommonSettings().FOR_STATEMENT_RPAREN_ON_NEXT_LINE = value;
    }
    ...
    public void setArrayInitializerWrap(WrapType value) {
        getCommonSettings().ARRAY_INITIALIZER_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setArrayInitializerLeftBraceOnNextLine(boolean value) {
        getCommonSettings().ARRAY_INITIALIZER_LBRACE_ON_NEXT_LINE = value;
    }
    ...
    public void setArrayInitializerRightBraceOnNextLine(boolean value) {
        getCommonSettings().ARRAY_INITIALIZER_RBRACE_ON_NEXT_LINE = value;
    }
    ...
    public void setAssignmentWrap(WrapType value) {
        getCommonSettings().ASSIGNMENT_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setPlaceAssignmentSignOnNextLine(boolean value) {
        getCommonSettings().PLACE_ASSIGNMENT_SIGN_ON_NEXT_LINE = value;
    }
    ...
    public void setWrapComments(boolean value) {
        getCommonSettings().WRAP_COMMENTS = value;
    }
    ...
    public void setAssertStatementWrap(WrapType value) {
        getCommonSettings().ASSERT_STATEMENT_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setAssertStatementColonOnNextLine(boolean value) {
        getCommonSettings().ASSERT_STATEMENT_COLON_ON_NEXT_LINE = value;
    }
    ...
    public void setIfBraceForce(ForceBraces value) {
        getCommonSettings().IF_BRACE_FORCE = value.intValue();
    }
    ...
    public void setDoWhileBraceForce(ForceBraces value) {
        getCommonSettings().DOWHILE_BRACE_FORCE = value.intValue();
    }
    ...
    public void setWhileBraceForce(ForceBraces value) {
        getCommonSettings().WHILE_BRACE_FORCE = value.intValue();
    }
    ...
    public void setForBraceForce(ForceBraces value) {
        getCommonSettings().FOR_BRACE_FORCE = value.intValue();
    }
    ...
    public void setWrapLongLines(boolean value) {
        getCommonSettings().WRAP_LONG_LINES = value;
    }
    ...
    public void setMethodAnnotationWrap(WrapType value) {
        getCommonSettings().METHOD_ANNOTATION_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setClassAnnotationWrap(WrapType value) {
        getCommonSettings().CLASS_ANNOTATION_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setFieldAnnotationWrap(WrapType value) {
        getCommonSettings().FIELD_ANNOTATION_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setParameterAnnotationWrap(WrapType value) {
        getCommonSettings().PARAMETER_ANNOTATION_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setVariableAnnotationWrap(WrapType value) {
        getCommonSettings().VARIABLE_ANNOTATION_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setSpaceBeforeAnotationParameterList(boolean value) {
        getCommonSettings().SPACE_BEFORE_ANOTATION_PARAMETER_LIST = value;
    }
    ...
    public void setSpaceWithinAnnotationParentheses(boolean value) {
        getCommonSettings().SPACE_WITHIN_ANNOTATION_PARENTHESES = value;
    }
    ...
    public void setEnumConstantsWrap(WrapType value) {
        getCommonSettings().ENUM_CONSTANTS_WRAP = wrapTypeToInt(value);
    }
    ...
    public void setFieldNamePrefix(String value) {
        getCustomSettings(JavaCodeStyleSettings.class).FIELD_NAME_PREFIX = value;
    }
    ...
    public void setStaticFieldNamePrefix(String value) {
        getCustomSettings(JavaCodeStyleSettings.class).STATIC_FIELD_NAME_PREFIX = value;
    }
    ...
    public void setParameterNamePrefix(String value) {
        getCustomSettings(JavaCodeStyleSettings.class).PARAMETER_NAME_PREFIX = value;
    }
    ...
    public void setLocalVariableNamePrefix(String value) {
        getCustomSettings(JavaCodeStyleSettings.class).LOCAL_VARIABLE_NAME_PREFIX = value;
    }
    ...
    public void setTestNamePrefix(String value) {
        getCustomSettings(JavaCodeStyleSettings.class).TEST_NAME_PREFIX = value;
    }
    ...
    public void setSubclassNamePrefix(String value) {
        getCustomSettings(JavaCodeStyleSettings.class).SUBCLASS_NAME_PREFIX = value;
    }
    ...
    public void setFieldNameSuffix(String value) {
        getCustomSettings(JavaCodeStyleSettings.class).FIELD_NAME_SUFFIX = value;
    }
    ...
    public void setStaticFieldNameSuffix(String value) {
        getCustomSettings(JavaCodeStyleSettings.class).STATIC_FIELD_NAME_SUFFIX = value;
    }
    ...
    public void setParameterNameSuffix(String value) {
        getCustomSettings(JavaCodeStyleSettings.class).PARAMETER_NAME_SUFFIX = value;
    }
    ...
    public void setLocalVariableNameSuffix(String value) {
        getCustomSettings(JavaCodeStyleSettings.class).LOCAL_VARIABLE_NAME_SUFFIX = value;
    }
    ...
    public void setTestNameSuffix(String value) {
        getCustomSettings(JavaCodeStyleSettings.class).TEST_NAME_SUFFIX = value;
    }
    ...
    public void setSubclassNameSuffix(String value) {
        getCustomSettings(JavaCodeStyleSettings.class).SUBCLASS_NAME_SUFFIX = value;
    }
    ...
    public void setPreferLongerNames(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).PREFER_LONGER_NAMES = value;
    }
    ...
    public void setGenerateFinalLocals(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).GENERATE_FINAL_LOCALS = value;
    }
    ...
    public void setGenerateFinalParameters(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).GENERATE_FINAL_PARAMETERS = value;
    }
    ...
    public void setVisibility(String value) {
        getCustomSettings(JavaCodeStyleSettings.class).VISIBILITY = value;
    }
    ...
    public void setUseExternalAnnotations(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).USE_EXTERNAL_ANNOTATIONS = value;
    }
    ...
    public void setRepeatSynchronized(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).REPEAT_SYNCHRONIZED = value;
    }
    ...
    public void setReplaceInstanceOf(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).REPLACE_INSTANCEOF = value;
    }
    ...
    public void setReplaceCast(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).REPLACE_CAST = value;
    }
    ...
    public void setReplaceNullCheck(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).REPLACE_NULL_CHECK = value;
    }
    ...
    public void setClassNamesInJavadoc(int value) {
        getCustomSettings(JavaCodeStyleSettings.class).CLASS_NAMES_IN_JAVADOC = value;
    }
    ...
    public void setUseFqClassNames(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).USE_FQ_CLASS_NAMES = value;
    }
    ...
    public void setUseSingleClassImports(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).USE_SINGLE_CLASS_IMPORTS = value;
    }
    ...
    public void setInsertInnerClassImports(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).INSERT_INNER_CLASS_IMPORTS = value;
    }
    ...
    public void setEnableJavadocFormatting(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).ENABLE_JAVADOC_FORMATTING = value;
    }
    ...
    public void setJavaDocAlignParamComments(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).JD_ALIGN_PARAM_COMMENTS = value;
    }
    ...
    public void setJavaDocPAtEmptyLines(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).JD_P_AT_EMPTY_LINES = value;
    }
    ...
    public void setJavaDocKeepInvalidTags(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).JD_KEEP_INVALID_TAGS = value;
    }
    ...
    public void setJavaDocKeepEmptyLines(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).JD_KEEP_EMPTY_LINES = value;
    }
    ...
    public void setJavaDocKeepEmptyParameter(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).JD_KEEP_EMPTY_PARAMETER = value;
    }
    ...
    public void setJavaDocKeepEmptyException(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).JD_KEEP_EMPTY_EXCEPTION = value;
    }
    ...
    public void setJavaDocKeepEmptyReturn(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).JD_KEEP_EMPTY_RETURN = value;
    }
    ...
    public void setJavaDocPreserveLineFeeds(boolean value) {
        getCustomSettings(JavaCodeStyleSettings.class).JD_PRESERVE_LINE_FEEDS = value;
    }
