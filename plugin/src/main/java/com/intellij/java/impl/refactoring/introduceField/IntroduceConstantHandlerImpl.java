...
public class IntroduceConstantHandlerImpl extends BaseExpressionToFieldHandler implements IntroduceConstantHandler {
    public static final LocalizeValue REFACTORING_NAME = RefactoringLocalize.introduceConstantTitle();
    ...
    protected boolean invokeImpl(@Nonnull Project project, PsiLocalVariable localVariable, final Editor editor) {
        ...
        LocalToFieldHandler localToFieldHandler = new LocalToFieldHandler(project, true) {
            ...
            protected Settings showRefactoringDialog(
                ...
                return IntroduceConstantHandlerImpl.this.showRefactoringDialog(
                    project,
                    editor,
                    aClass,
    ...
    protected Settings showRefactoringDialog(
        ...
        else if (anchorElement instanceof PsiLocalVariable localVar) {
            localVariable = localVar;
        }
        ...
        for (PsiExpression occurrence : occurrences) {
            if (RefactoringUtil.isAssignmentLHS(occurrence)) {
                LocalizeValue message = RefactoringLocalize.cannotPerformRefactoringWithReason(LocalizeValue.localizeTODO(
                    "Selected expression is used for write"
                ));
                CommonRefactoringUtil.showErrorHint(project, editor, message, REFACTORING_NAME, getHelpID());
        ...
        if (editor != null && editor.getSettings().isVariableInplaceRenameEnabled() &&
            ...
            myInplaceIntroduceConstantPopup = new InplaceIntroduceConstantPopup(
                project,
                editor,
                parentClass,
                expr,
