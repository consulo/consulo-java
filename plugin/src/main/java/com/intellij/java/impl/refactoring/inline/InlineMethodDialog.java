...
public class InlineMethodDialog extends InlineOptionsWithSearchSettingsDialog {
    ...
    public InlineMethodDialog(
        ...
        setTitle(RefactoringLocalize.inlineMethodTitle());
    ...
    protected void doAction() {
        super.doAction();
        invokeRefactoring(new InlineMethodProcessor(
            getProject(),
            myMethod,
            myReferenceElement,
            myEditor,
    ...
    protected void doHelpAction() {
        HelpManager.getInstance().invokeHelp(myMethod.isConstructor() ? HelpID.INLINE_CONSTRUCTOR : HelpID.INLINE_METHOD);
    }
