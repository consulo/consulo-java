...
public class InplaceIntroduceFieldPopup extends AbstractInplaceIntroduceFieldPopup {
    ...
    public InplaceIntroduceFieldPopup(
        ...
        myStatic = aStatic;
        myIntroduceFieldPanel = new IntroduceFieldPopupPanel(
            parentClass,
            initializerExpression,
            localVariable,
        ...
        JComponent centerPanel = myIntroduceFieldPanel.createCenterPanel();
    ...
    protected PsiField createFieldToStartTemplateOn(
        final String[] names,
    ...
    public static SuggestedNameInfo suggestFieldName(
        @Nullable PsiType defaultType,
            ...
            protected void run(Result result) throws Throwable {
                if (getLocalVariable() != null) {
                    final LocalToFieldHandler.IntroduceFieldRunnable fieldRunnable =
                        new LocalToFieldHandler.IntroduceFieldRunnable(
                            false,
                            (PsiLocalVariable) getLocalVariable(),
                            myParentClass,
                            settings,
