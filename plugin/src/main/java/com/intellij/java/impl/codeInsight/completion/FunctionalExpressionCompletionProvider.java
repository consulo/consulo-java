...
public class FunctionalExpressionCompletionProvider implements CompletionProvider {
  ...
  static void addFunctionalVariants(@jakarta.annotation.Nonnull CompletionParameters parameters, boolean smart, boolean addInheritors, PrefixMatcher matcher, Consumer<LookupElement> result) {
  ...
  private static LookupElement createConstructorReferenceLookup(@jakarta.annotation.Nonnull PsiType functionalInterfaceType, @Nonnull PsiType constructedType) {
