...
public class UnnecessaryToStringCallInspection extends BaseInspection {
  ...
  public String getDisplayName() {
    return InspectionGadgetsLocalize.unnecessaryTostringCallDisplayName().get();
  }
  ...
  protected String buildErrorString(Object... infos) {
    ...
    return InspectionGadgetsLocalize.unnecessaryTostringCallProblemDescriptor(text).get();
  }
