...
import static consulo.util.lang.StringUtil.isVowel;
...
public final class PastParticiple {
  ...
  private static final Map<String, String> IRREGULAR_VERBS = Maps.newHashMap(IRREGULAR_SIZE, HashingStrategy.caseInsensitive());
  private static final int DOUBLED_SIZE = 444;
  private static final Set<String> DOUBLED_FINAL_CONSONANTS = Sets.newHashSet(DOUBLED_SIZE, HashingStrategy.caseInsensitive());
  ...
  String generateHeuristicDoubledFinalConsonantPastParticiple(String verb) {
