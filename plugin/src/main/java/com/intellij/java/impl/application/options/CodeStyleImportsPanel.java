...
public class CodeStyleImportsPanel extends JPanel {
    ...
    private JPanel createGeneralOptionsPanel() {
        ...
        panel.add(
            new JLabel(ApplicationBundle.message("editbox.names.count.to.use.static.import.with.star")),
    ...
    public boolean isModified(JavaCodeStyleSettings settings) {
        boolean isModified =
            isModified(myImportLayoutPanel.getCbLayoutStaticImportsSeparately(), settings.LAYOUT_STATIC_IMPORTS_SEPARATELY);
