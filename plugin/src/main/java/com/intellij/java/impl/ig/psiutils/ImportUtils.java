...
public class ImportUtils {
  ...
  public static void addImportIfNeeded(@jakarta.annotation.Nonnull PsiClass aClass, @Nonnull PsiElement context) {
  ...
  private static boolean nameCanBeStaticallyImported(@jakarta.annotation.Nonnull String fqName, @jakarta.annotation.Nonnull String memberName, @jakarta.annotation.Nonnull PsiElement context) {
  ...
  public static boolean nameCanBeImported(@jakarta.annotation.Nonnull String fqName, @jakarta.annotation.Nonnull PsiElement context) {
    final PsiClass containingClass = PsiTreeUtil.getParentOfType(context, PsiClass.class);
    if (containingClass != null) {
  ...
  public static boolean hasOnDemandImportConflict(@Nonnull String fqName, @jakarta.annotation.Nonnull PsiJavaFile file) {
   ...
   */
  private static boolean hasOnDemandImportConflict(@Nonnull String fqName, @jakarta.annotation.Nonnull PsiJavaFile file, boolean strict) {
    final PsiImportList imports = file.getImportList();
    if (imports == null) {
      return false;
    }
  ...
  public static boolean addStaticImport(@jakarta.annotation.Nonnull String qualifierClass, @NonNls @Nonnull String memberName, @jakarta.annotation.Nonnull PsiElement context) {
  ...
  private static List<PsiImportStaticStatement> getMatchingImports(@jakarta.annotation.Nonnull PsiImportList importList, @Nonnull String className) {
  ...
  public static boolean isStaticallyImported(@jakarta.annotation.Nonnull PsiMember member, @jakarta.annotation.Nonnull PsiElement context) {
  ...
  public static boolean isAlreadyStaticallyImported(PsiJavaCodeReferenceElement reference) {
    ...
    final PsiMember member = ObjectUtil.tryCast(reference.resolve(), PsiMember.class);
    if (member == null) {
      return false;
    }
  ...
  private static boolean isReferenceCorrectWithoutQualifier(@jakarta.annotation.Nonnull PsiJavaCodeReferenceElement reference, @Nonnull PsiMember member) {
