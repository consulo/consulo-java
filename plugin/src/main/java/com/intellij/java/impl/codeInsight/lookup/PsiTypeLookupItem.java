...
public class PsiTypeLookupItem extends LookupItem implements TypedLookupItem {
  ...
  public PsiType getType() {
    ...
    PsiType type = object instanceof PsiType ? getSubstitutor().substitute((PsiType) object) : JavaPsiFacade.getElementFactory(((PsiClass) object).getProject()).createType((PsiClass) object,
        getSubstitutor());
