...
public class DefaultClsStubBuilderFactory extends ClsStubBuilderFactory
{
	...
	public PsiFileStub buildFileStub(VirtualFile vFile, byte[] bytes) throws ClsFormatException
	{
		...
		try
		{
			...
			final StubBuildingVisitor<VirtualFile> classVisitor = new StubBuildingVisitor<VirtualFile>(vFile,
					VirtualFileInnerClassStrategy.INSTANCE, file, 0, vFile.getNameWithoutExtension());
			try
			{
