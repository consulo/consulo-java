...
public interface PsiModifierListOwner extends PsiElement {
   ...
   */
  boolean hasModifierProperty(@PsiModifier.ModifierConstant @NonNls @jakarta.annotation.Nonnull String name);
  ...
  default boolean hasModifier(@jakarta.annotation.Nonnull JvmModifier modifier) {
    return PsiJvmConversionHelper.hasListModifier(this, modifier);
  }

  @Nullable
  default PsiAnnotation getAnnotation(@jakarta.annotation.Nonnull String fqn) {
