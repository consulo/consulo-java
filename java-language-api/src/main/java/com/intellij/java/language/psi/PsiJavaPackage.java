...
public interface PsiJavaPackage extends PsiJvmModifiersOwner, PsiPackage {
   ...
   * @return the array of subpackages.
   */
  PsiJavaPackage[] getSubPackages(GlobalSearchScope scope);
   ...
   */
  PsiFile[] getFiles(GlobalSearchScope scope);
  ...
  PsiClass[] findClassByShortName(String name, GlobalSearchScope scope);
}
