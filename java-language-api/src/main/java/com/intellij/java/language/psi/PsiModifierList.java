...
public interface PsiModifierList extends PsiElement, PsiAnnotationOwner {
     ...
     */
    boolean hasExplicitModifier(@PsiModifier.ModifierConstant String name);
     ...
     */
    void setModifierProperty(@PsiModifier.ModifierConstant String name, boolean value) throws IncorrectOperationException;
     ...
     * @throws IncorrectOperationException if the modification fails for some reason.
     */
    void checkSetModifierProperty(@PsiModifier.ModifierConstant String name, boolean value)
