...
public class DeprecationUtil {
    ...
    public static final LocalizeValue DEPRECATION_DISPLAY_NAME = InspectionLocalize.inspectionDeprecatedDisplayName();
    public static final String DEPRECATION_ID = "deprecation";

    public static final String FOR_REMOVAL_SHORT_NAME = "MarkedForRemoval";
    public static final LocalizeValue FOR_REMOVAL_DISPLAY_NAME = InspectionLocalize.inspectionMarkedForRemovalDisplayName();
