...
public class ClassRenderer extends NodeRendererImpl {
    ...
    protected static String calcLabel(ValueDescriptor descriptor) {
        ...
        if (value instanceof ObjectReference) {
            ...
            return JavaDebuggerLocalize.labelUndefined().get();
        }
    }
    ...
    public void buildChildren(final Value value, final ChildrenBuilder builder, final EvaluationContext evaluationContext) {
        ...
        if (value instanceof ObjectReference) {
            ...
            if (!fields.isEmpty()) {
                ...
                if (children.isEmpty()) {
                    children.add(nodeManager.createMessageNode(JavaDebuggerLocalize.messageNodeClassNoFieldsToDisplay()));
                }
    ...
    public PsiElement getChildValueExpression(DebuggerTreeNode node, DebuggerContext context) throws EvaluateException {
        ...
        try {
            ...
            throw new EvaluateException(JavaDebuggerLocalize.errorInvalidFieldName(fieldDescriptor.getField().name()).get(), null);
        }
    }
