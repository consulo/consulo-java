...
public abstract class DebuggerTree extends DebuggerTreeBase implements DataProvider {
    ...
    public void showMessage(LocalizeValue messageText) {
        ...
        public void threadAction() {
            try {
                ...
                try {
                    ...
                    myChildren.add(myNodeManager.createMessageNode(new MessageDescriptor(LocalizeValue.of(e.getMessage()))));
                }
                ...
                if (e.errorCode() == 35) {
                    myChildren.add(myNodeManager.createMessageNode(new MessageDescriptor(JavaDebuggerLocalize.errorCorruptDebugInfo(e.getMessage()))));
                }
                else {
                    throw e;
                }
        ...
        public void threadAction(@Nonnull SuspendContextImpl suspendContext) {
            ...
            try {
                ...
                DebuggerInvocationUtil.swingInvokeLater(getProject(), () ->
                {
                    ...
                    node.add(getNodeFactory().createMessageNode(new MessageDescriptor(JavaDebuggerLocalize.errorCannotBuildNodeChildrenObjectCollected(message))));
            ...
            if (!threadProxy.isCollected() && getDebuggerContext().getDebugProcess().getSuspendManager().isSuspended(threadProxy)) {
                ...
                if (!(status == ThreadReference.THREAD_STATUS_UNKNOWN) &&
                    ...
                    try {
                        ...
                        myChildren.clear();
                        myChildren.add(myNodeManager.createMessageNode(LocalizeValue.of(e.getMessage())));
                        LOG.debug(e);
                        //LOG.assertTrue(false);
