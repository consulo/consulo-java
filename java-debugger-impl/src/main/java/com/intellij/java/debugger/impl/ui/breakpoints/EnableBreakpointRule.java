...
public class EnableBreakpointRule {
  ...
  public EnableBreakpointRule(BreakpointManager manager, Breakpoint masterBreakpoint, Breakpoint slaveBreakpoint) {
    this(manager,masterBreakpoint, slaveBreakpoint, false);
  }

  public EnableBreakpointRule(BreakpointManager manager, Breakpoint masterBreakpoint, Breakpoint slaveBreakpoint, boolean leaveEnabled) {
