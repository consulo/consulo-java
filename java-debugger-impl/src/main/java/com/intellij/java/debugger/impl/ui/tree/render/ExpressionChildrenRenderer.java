...
public class ExpressionChildrenRenderer extends TypeRenderer implements ChildrenRenderer {
    ...
    public void buildChildren(final Value value, final ChildrenBuilder builder, final EvaluationContext evaluationContext) {
        ...
        try {
            ...
            errorChildren.add(nodeManager.createMessageNode(LocalizeValue.join(
                    JavaDebuggerLocalize.errorUnableToEvaluateExpression(),
                    LocalizeValue.space(),
                    LocalizeValue.of(e.getMessage())
                )
            ));
    ...
    public PsiExpression getChildValueExpression(DebuggerTreeNode node, DebuggerContext context) throws EvaluateException {
        ...
        if (expressionValue == null) {
            throw EvaluateExceptionUtil.createEvaluateException(JavaDebuggerLocalize.errorUnableToEvaluateExpression());
        }
