...
public class CapturePoint implements Cloneable
{
	...
	public boolean equals(Object o)
	{
		...
		if(myEnabled != that.myEnabled)
		{
			return false;
		}
		if(myClassName != null ? !myClassName.equals(that.myClassName) : that.myClassName != null)
		{
			return false;
		}
		if(myMethodName != null ? !myMethodName.equals(that.myMethodName) : that.myMethodName != null)
		{
			return false;
		}
		if(myCaptureKeyExpression != null ? !myCaptureKeyExpression.equals(that.myCaptureKeyExpression) : that.myCaptureKeyExpression != null)
		{
			return false;
		}
		if(myInsertClassName != null ? !myInsertClassName.equals(that.myInsertClassName) : that.myInsertClassName != null)
		{
			return false;
		}
		if(myInsertMethodName != null ? !myInsertMethodName.equals(that.myInsertMethodName) : that.myInsertMethodName != null)
		{
			return false;
		}
