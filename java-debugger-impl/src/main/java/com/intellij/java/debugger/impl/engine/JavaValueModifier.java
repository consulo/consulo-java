...
public abstract class JavaValueModifier extends XValueModifier
{
	...
	//          ExpressionEvaluator evaluator = DebuggerInvocationUtil.commitAndRunReadAction(evaluationContext.getProject(), new com.intellij.java.debugger.impl.EvaluatingComputable<ExpressionEvaluator>() {
	//            public ExpressionEvaluator compute() throws EvaluateException {
