...
public class AdjustArrayRangeAction extends DebuggerAction
{
	...
	public void actionPerformed(AnActionEvent e)
	{
		...
		final ArrayRenderer renderer = getArrayRenderer((ValueDescriptorImpl) descriptor)/*(ArrayRenderer)((ValueDescriptorImpl)selectedNode
	...
	private static ArrayRenderer getArrayRenderer(ValueDescriptorImpl descriptor)
	{
		...
		if(lastRenderer instanceof CompoundNodeRenderer && ((CompoundNodeRenderer) lastRenderer).getChildrenRenderer() instanceof
