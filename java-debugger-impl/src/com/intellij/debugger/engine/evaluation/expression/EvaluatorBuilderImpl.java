...
public class EvaluatorBuilderImpl implements EvaluatorBuilder
{
	...
	private static class Builder extends JavaElementVisitor
	{
		...
		public void visitPostfixExpression(PsiPostfixExpression expression)
		{
			...
			Evaluator incrementImpl = createBinaryEvaluator(operandEvaluator, operandType, new LiteralEvaluator(Integer.valueOf(1), "int"), PsiType.INT,
					operation == JavaTokenType.PLUSPLUS ? JavaTokenType.PLUS : JavaTokenType.MINUS, unboxedOperandType != null ? unboxedOperandType : operandType);
		...
		public void visitPrefixExpression(final PsiPrefixExpression expression)
		{
			...
			if(operation == JavaTokenType.PLUSPLUS || operation == JavaTokenType.MINUSMINUS)
			{
				try
				{
					final BinaryExpressionEvaluator rightEval = createBinaryEvaluator(operandEvaluator, operandType, new LiteralEvaluator(Integer.valueOf(1), "int"), PsiType.INT,
							operation == JavaTokenType.PLUSPLUS ? JavaTokenType.PLUS : JavaTokenType.MINUS, unboxedOperandType != null ? unboxedOperandType : operandType);
		...
		public void visitTypeCastExpression(PsiTypeCastExpression expression)
		{
			...
			{
				throw new EvaluateRuntimeException(new EvaluateException(JavaErrorMessages.message("inconvertible.type.cast", JavaHighlightUtil.formatType(operandType),
