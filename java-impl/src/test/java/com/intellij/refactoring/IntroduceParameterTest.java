...
public abstract class IntroduceParameterTest extends LightRefactoringTestCase
{
	...
	{
		doTest(IntroduceParameterRefactoring.REPLACE_FIELDS_WITH_GETTERS_NONE, false, false, false, false, "field <b><code>Test.i</code></b> is not accessible from method <b><code>XTest.n()" +
				"</code></b>. Value for introduced parameter in that method call will be incorrect.");
	}
	...
	{
		doTest(IntroduceParameterRefactoring.REPLACE_FIELDS_WITH_GETTERS_INACCESSIBLE, false, false, false, false, "Parameter initializer contains <b><code>super</code></b>, but not all calls to " +
				"method are in its class.");
	}
	...
	public void testIncompleteVararg() throws Exception
	{
		doTest(IntroduceParameterRefactoring.REPLACE_FIELDS_WITH_GETTERS_INACCESSIBLE, true, false, true, false, "Incomplete call(method()): 2 parameters expected but only 0 found\n" + "Incomplete " +
				"call(method()): expected to delete the 0 parameter but only 0 parameters found");
	}
