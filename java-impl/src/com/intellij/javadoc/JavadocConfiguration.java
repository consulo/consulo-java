...
{
	public static final SerializationFilter FILTER = (accessor, bean) -> !accessor.getName().equals("OPTION_LINK_TO_JDK_DOCS") || ((JavadocConfiguration) bean).OPTION_LINK_TO_JDK_DOCS;
