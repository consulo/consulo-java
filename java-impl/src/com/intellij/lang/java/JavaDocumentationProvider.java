...
public class JavaDocumentationProvider implements CodeDocumentationProvider, ExternalDocumentationProvider
{
	...
	public static String formatMethodSignature(PsiMethod method)
	{
		return PsiFormatUtil.formatMethod(method, PsiSubstitutor.EMPTY, PsiFormatUtilBase.SHOW_NAME |
				...
				PsiFormatUtilBase.SHOW_RAW_NON_TOP_TYPE, PsiFormatUtilBase.SHOW_TYPE |
				PsiFormatUtilBase.SHOW_FQ_CLASS_NAMES |
				PsiFormatUtilBase.SHOW_RAW_NON_TOP_TYPE, 999);
	}
	...
	@Nullable
	public static List<String> findUrlForVirtualFile(final Project project,
