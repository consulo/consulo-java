...
public class UnusedDeclarationInspection extends GlobalInspectionTool
{
	...
	@NonNls
	private static final String ALTERNATIVE_ID = "unused";
	...
	{
		EntryPoint[] extensions = JavaExtensionPoints.DEAD_CODE_EP_NAME.getExtensions();
	...
	private class OptionsPanel extends JPanel
	{
		...
		private OptionsPanel()
		{
			...
			myNonJavaCheckbox = new JCheckBox(InspectionsBundle.message("inspection.dead.code.option5"));
