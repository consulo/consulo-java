...
public abstract class ForkedSplitter extends ForkedByModuleSplitter
{
	...
	protected int startPerModuleFork(String moduleName, List classNames, String packageName, String workingDir, String classpath, String repeatCount, int result) throws Exception
	{
