...
public class JamService {
  ...
  @Nullable
  public <T extends JamElement> T getJamElement(PsiElement psi,
  ...
  @Nullable
  public <T extends JamElement> T getJamElement(SemKey<T> key, PsiElement psi) {
    if (!psi.isValid()) {
  ...
  public <T extends PsiModifierListOwner> List<JamMemberMeta> getMetas(T psi) {
    return mySemService.getSemElements(JamService.MEMBER_META_KEY, psi);
  }

  @Nullable
  public <T extends PsiModifierListOwner> JamMemberMeta<T, ?> getMeta(T psi, SemKey<? extends JamMemberMeta<T, ?>> key) {
    return mySemService.getSemElement(key, psi);
  }
  ...
  public <T extends JamElement> List<T> getAnnotatedMembersList(final PsiClass psiClass,
  ...
  public <T extends JamElement> List<T> getJamClassElements(final SemKey<T> c, final String anno, final GlobalSearchScope scope) {
    final List<T> result = ContainerUtil.newArrayList();
  ...
  public <T extends JamElement> List<T> getJamMethodElements(final SemKey<T> c, final String anno, final GlobalSearchScope scope) {
    final List<T> result = ContainerUtil.newArrayList();
  ...
  public <T extends JamElement> List<T> getJamFieldElements(final SemKey<T> c, final String anno, final GlobalSearchScope scope) {
    final List<T> result = ContainerUtil.newArrayList();
