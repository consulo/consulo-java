...
public class JavacOutputParser implements BuildOutputParser {
    ...
    public JavacOutputParser(BuildEventFactory buildEventFactory) {
        this(buildEventFactory, "java");
    }

    public JavacOutputParser(BuildEventFactory buildEventFactory, String... fileExtensions) {
