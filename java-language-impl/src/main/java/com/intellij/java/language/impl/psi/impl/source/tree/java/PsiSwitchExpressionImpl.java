...
import consulo.java.language.impl.util.ArrayUtil2;
...
public class PsiSwitchExpressionImpl extends PsiSwitchBlockImpl implements PsiSwitchExpression {
  ...
  public PsiType getType() {
    ...
    int maxRank = ArrayUtil2.max(ranks);
    ...
    //Otherwise, boxing conversion (5.1.7) is applied to each result expression that has a primitive type, after which the type of the switch expression is the result of applying capture
    // conversion (5.1.10)
