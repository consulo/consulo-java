...
public /*sealed*/ abstract class TypeInfo {
  ...
  static {
    ...
    for (int i = 0; i < ourIndexFrequentType.length; i++) {
      ...
      ourFrequentTypeIndex.putInt(type, i);
  ...
  private static void collectAnnotations(@Nonnull TypeInfo info,
  ...
  @Nonnull
  private static TypeInfo fromTypeElement(@Nonnull LighterAST tree,
                                          @Nonnull LighterASTNode typeElement) {
    TypeInfo info = null;
