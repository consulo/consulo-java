...
import com.intellij.java.language.impl.psi.impl.cache.ExplicitTypeAnnotationContainer;
...
public final class SignatureParsing {
    ...
    public interface TypeInfoProvider {
         ...
         */
        default boolean isKnownStatic(String jvmClassName) {
            return false;
        }
    ...
    public static class TypeParametersDeclaration {
        public static final TypeParametersDeclaration EMPTY = new TypeParametersDeclaration(Collections.emptyList());
        ...
        void fillInTypeParameterList(StubElement<?> parent) {
            ...
            PsiTypeParameterListStub listStub = ObjectUtil.tryCast(parent.findChildStubByType(JavaStubElementTypes.TYPE_PARAMETER_LIST), PsiTypeParameterListStub.class);
            if (listStub == null) {
                return;
            }
     ...
     */
    public static TypeInfo parseTypeStringToTypeInfo(CharIterator signature, TypeInfoProvider mapping) throws ClsFormatException {
        int dimensions = parseDimensions(signature);
