...
public abstract class PsiTypeMapper extends PsiTypeVisitorEx<PsiType> {
  ...
  public PsiType visitCapturedWildcardType(final PsiCapturedWildcardType type) {
    ...
    if (mapped == null) {
      ...
      final PsiCapturedWildcardType capturedWildcardType = PsiCapturedWildcardType.create(mapped,
          type.getContext(), type.getTypeParameter());
  ...
  public PsiType visitWildcardType(final PsiWildcardType wildcardType) {
    ...
    return wildcardType.isExtends() ? PsiWildcardType.createExtends(manager, bound) : PsiWildcardType.createSuper
        (manager, bound);
  }
