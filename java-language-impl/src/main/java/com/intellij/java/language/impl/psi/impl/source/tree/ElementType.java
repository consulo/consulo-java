...
public interface ElementType extends JavaTokenType, JavaDocTokenType, JavaElementType, JavaDocElementType {
  ...
  TokenSet OPERATION_BIT_SET = TokenSet.create(EQ,
                                               GT,
                                               LT,
                                               EXCL,
                                               TILDE,
  ...
  TokenSet PRIMITIVE_TYPE_BIT_SET = TokenSet.create(BOOLEAN_KEYWORD,
                                                    BYTE_KEYWORD,
                                                    SHORT_KEYWORD,
                                                    INT_KEYWORD,
                                                    LONG_KEYWORD,
  ...
  TokenSet ARRAY_DIMENSION_BIT_SET = TokenSet.create(REFERENCE_EXPRESSION,
                                                     LITERAL_EXPRESSION,
                                                     THIS_EXPRESSION,
                                                     SUPER_EXPRESSION,
                                                     PARENTH_EXPRESSION,
  ...
  TokenSet JAVA_STATEMENT_BIT_SET = TokenSet.create(EMPTY_STATEMENT,
                                                    BLOCK_STATEMENT,
