...
public final class ExplicitTypeAnnotationContainer implements TypeAnnotationContainer {
    ...
    public TypeAnnotationProvider getProvider(PsiElement parent) {
        return new TypeAnnotationContainerProvider(parent, ObjectUtil.tryCast(parent, PsiAnnotationOwner.class));
    }
     ...
     */
    public static void writeTypeAnnotations(StubOutputStream dataStream, ExplicitTypeAnnotationContainer container)
        throws IOException {
     ...
     * @throws IOException if the stream throws
     */
    public static TypeAnnotationContainer readTypeAnnotations(StubInputStream dataStream) throws IOException {
    ...
    private static String encodePath(byte[] path) {
    ...
    public static class Collector {
        ...
        private final ArrayList<TypeAnnotationEntry> myList = new ArrayList<>();
        protected final TypeInfo myTypeInfo;

        public Collector(TypeInfo info) {
            myTypeInfo = info;
        }

        public void add(byte[] path, String text) {
    ...
    private static class TypeAnnotationEntry {
        ...
        private TypeAnnotationEntry(byte[] path, String text) {
    ...
    static class ClsTypeAnnotationImpl extends ClsElementImpl implements PsiAnnotation {
        ...
        public PsiElement[] getChildren() {
            return new PsiElement[]{myReferenceElement.get(), getParameterList()};
        }
    ...
    private class TypeAnnotationContainerProvider implements TypeAnnotationProvider {
        ...
        @Override
        public TypeAnnotationProvider withOwner(PsiAnnotationOwner owner) {
            return new TypeAnnotationContainerProvider(myParent, owner);
        }

        private PsiAnnotation[] computeAnnotations() {
