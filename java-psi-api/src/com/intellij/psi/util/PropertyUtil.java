...
public class PropertyUtil
{
	...
	public static Map<String, PsiMethod> getAllProperties(final boolean acceptSetters, final boolean acceptGetters, PsiMethod[] methods)
	{
		...
		for(PsiMethod method : methods)
		{
			...
			if(acceptSetters && isSimplePropertySetter(method) || acceptGetters && isSimplePropertyGetter(method))
			{
	...
	private static void annotate(@NotNull PsiModifierListOwner listOwner, @NotNull PsiAnnotation annotation) throws IncorrectOperationException
	{
