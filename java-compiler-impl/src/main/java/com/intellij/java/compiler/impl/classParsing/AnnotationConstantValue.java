...
public class AnnotationConstantValue extends ConstantValue {
  ...
  public boolean equals(Object o) {
    ...
    AnnotationConstantValue that = (AnnotationConstantValue) o;
    return myQName == that.myQName &&
        Arrays.equals(myMemberValues, that.myMemberValues);
  }

  @Override
  public int hashCode() {
    return Objects.hash(myQName, myMemberValues);
  }
}
