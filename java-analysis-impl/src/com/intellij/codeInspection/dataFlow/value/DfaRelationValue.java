...
public class DfaRelationValue extends DfaValue
{
	...
	public static class Factory
	{
		...
		public DfaRelationValue createRelation(DfaValue dfaLeft, DfaValue dfaRight, IElementType relation, boolean negated)
		{
			...
			if(dfaLeft instanceof DfaVariableValue || dfaLeft instanceof DfaBoxedValue || dfaLeft instanceof DfaUnboxedValue || dfaRight instanceof
					DfaVariableValue || dfaRight instanceof DfaBoxedValue || dfaRight instanceof DfaUnboxedValue)
			{
		...
		private DfaRelationValue createCanonicalRelation(IElementType relation, boolean negated, @NotNull final DfaValue dfaLeft,
				@NotNull final DfaValue dfaRight)
		{
			...
			else
			{
				...
				{
					if(rel.hardEquals(mySharedInstance))
					{
						return rel;
					}
				}
	...
	{
		return Comparing.equal(rel.myLeftOperand, myLeftOperand) && Comparing.equal(rel.myRightOperand, myRightOperand) &&
