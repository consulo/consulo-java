...
public class StandardInstructionVisitor extends InstructionVisitor
{
			...
			double comparedWith)
	{
		...
		if(PsiType.FLOAT.equals(varType) || PsiType.DOUBLE.equals(varType))
		{
			return null;
		}

		double minValue = PsiType.BYTE.equals(varType) ? Byte.MIN_VALUE : PsiType.SHORT.equals(varType) ? Short.MIN_VALUE : PsiType.INT.equals(varType) ? Integer.MIN_VALUE : PsiType.CHAR.equals
				(varType) ? Character
				.MIN_VALUE : Long.MIN_VALUE;
		double maxValue = PsiType.BYTE.equals(varType) ? Byte.MAX_VALUE : PsiType.SHORT.equals(varType) ? Short.MAX_VALUE : PsiType.INT.equals(varType) ? Integer.MAX_VALUE : PsiType.CHAR.equals(varType) ? Character
