...
public class MethodCallUtils {
    ...
    public static boolean isCallToStaticMethod(
        ...
        if (method == null || !method.hasModifierProperty(PsiModifier.STATIC) || method.getParameterList()
            .getParametersCount() != parameterCount || !method.isVarArgs() && args.length !=
            parameterCount) {
            return false;
        }
    ...
    public static boolean isVarArgCall(PsiCall call) {
        ...
        return MethodCallInstruction.isVarArgCall(
            method,
            substitutor,
            call.getArgumentList().getExpressions(),
