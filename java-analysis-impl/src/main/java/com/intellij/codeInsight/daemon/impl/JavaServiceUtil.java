...
final class JavaServiceUtil
{
	...
	static boolean isServiceProviderMethod(@Nonnull PsiMethod method)
	{
	...
	@Nonnull
	static List<LineMarkerInfo<PsiElement>> collectServiceProviderMethod(@Nonnull PsiMethod method)
	{
	...
	@Nonnull
	static List<LineMarkerInfo<PsiElement>> collectServiceImplementationClass(@Nonnull PsiClass psiClass)
	{
	...
	static List<LineMarkerInfo<PsiElement>> collectServiceLoaderLoadCall(@Nonnull PsiIdentifier identifier,
