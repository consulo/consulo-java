...
public abstract class NullableStuffInspectionBase extends AbstractBaseJavaLocalInspectionTool {
  ...
  private void checkAccessors(PsiField field,
                              Annotated annotated,
                              Project project,
                              NullableNotNullManager manager, final String anno, final List<String> annoToRemove, @Nonnull ProblemsHolder holder) {
  ...
  private void checkConstructorParameters(PsiField field,
                                          ...
                                          String anno, List<String> annoToRemove, @Nonnull ProblemsHolder holder) {
  ...
  private void checkNullLiteralArgumentOfNotNullParameterUsages(PsiMethod method,
                                                                ...
                                                                int parameterIdx,
                                                                PsiParameter parameter) {
    if (!REPORT_NULLS_PASSED_TO_NOT_NULL_PARAMETER || !isOnFly) {
      return;
    }
