...
public abstract class ContractReturnValue {
    ...
    private interface Validator extends Function<PsiMethod, String> {
    }
        ...
        Stream<Validator> validators() {
            return Stream.of(NOT_CONSTRUCTOR, NOT_STATIC, NOT_PRIMITIVE_RETURN, method -> {
                ...
                if (returnType instanceof PsiClassType) {
                    ...
                    if (aClass != null && JavaPsiFacade.getElementFactory(method.getProject())
                        .createType(aClass)
                        .isConvertibleFrom(returnType)) {
                        return null;
                    }
                }
