...
public final class NullabilityProblemKind<T extends PsiElement> {
  ...
  @Nullable
  public static NullabilityProblem<?> fromContext(@Nonnull PsiExpression expression,
  ...
  @Nullable
  private static NullabilityProblem<?> getExpressionListProblem(@Nonnull PsiExpressionList expressionList,
  ...
  @Nullable
  private static NullabilityProblem<?> getArrayInitializerProblem(@Nonnull PsiArrayInitializerExpression initializer,
                                                                  @Nonnull PsiExpression expression,
                                                                  @Nonnull PsiExpression context) {
  ...
  @Nullable
  private static NullabilityProblem<?> getAssignmentProblem(@Nonnull PsiAssignmentExpression assignment,
                                                            @Nonnull PsiExpression expression,
                                                            @Nonnull PsiExpression context) {
    ...
    if (assignment.getRExpression() == context) {
      ...
      if (lho != null) {
        ...
        if (lho instanceof PsiReferenceExpression) {
          target = ObjectUtil.tryCast(((PsiReferenceExpression) lho).resolve(), PsiVariable.class);
          if (target != null) {
        ...
        if (nullability == Nullability.UNKNOWN && lho instanceof PsiReferenceExpression) {
          PsiField field = ObjectUtil.tryCast(((PsiReferenceExpression) lho).resolve(), PsiField.class);
  ...
  private static NullabilityProblem<PsiElement> createUnboxingProblem(@Nonnull PsiExpression context,
                                                                      @Nonnull PsiExpression expression) {
  ...
  public static final class NullabilityProblem<T extends PsiElement> {
    private final
    @Nonnull
    NullabilityProblemKind<T> myKind;
    private final
    @Nonnull
    T myAnchor;
    private final
    @Nullable
    PsiExpression myDereferencedExpression;
