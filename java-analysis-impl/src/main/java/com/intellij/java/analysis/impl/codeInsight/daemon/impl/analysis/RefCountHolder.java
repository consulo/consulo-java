...
import consulo.ide.impl.idea.util.containers.Predicate;
...
public class RefCountHolder {
  ...
  @Nonnull
  public static RefCountHolder get(@Nonnull PsiFile file) {
  ...
  public void registerLocallyReferenced(@Nonnull PsiNamedElement result) {
    myDclsUsedMap.put(PsiAnchor.create(result), Boolean.TRUE);
  }

  public void registerReference(@Nonnull PsiReference ref, @Nonnull JavaResolveResult resolveResult) {
  ...
  public boolean analyze(@Nonnull PsiFile file, TextRange dirtyScope, @Nonnull ProgressIndicator indicator, @Nonnull Runnable analyze) {
