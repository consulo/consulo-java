...
public enum LongRangeBinOp
{
	 ...
	 */
	public
	LongRangeSet eval(LongRangeSet left, LongRangeSet right, boolean isLong)
	{
		switch(this)
		{
			case PLUS:
	 ...
	 */
	public
	LongRangeSet evalWide(LongRangeSet left, LongRangeSet right, boolean isLong)
	{
		switch(this)
		{
			case PLUS:
	...
	public static
	@Nullable
	LongRangeBinOp fromToken(IElementType token)
	{
		if(token == null)
		{
			return null;
