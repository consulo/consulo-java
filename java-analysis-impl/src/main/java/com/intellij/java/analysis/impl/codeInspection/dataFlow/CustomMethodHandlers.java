...
import com.intellij.java.analysis.impl.codeInspection.dataFlow.types.DfIntType;
...
import static com.intellij.java.analysis.impl.codeInspection.dataFlow.SpecialField.*;
...
final class CustomMethodHandlers
{
	...
	private static Object getConstantValue(DfaMemoryState memoryState, DfaValue value)
	{
		...
		if(constant instanceof String && ((String) constant).length() > MAX_STRING_CONSTANT_LENGTH_TO_TRACK)
		{
			return null;
		}
		return constant;
