...
final class NullableStuffInspectionUtil {
    static @NotNull HtmlChunk getNullabilityConflictPresentation(@NotNull JavaTypeNullabilityUtil.NullabilityConflictContext context) {
    ...
    private static @NotNull HtmlChunk generateHtmlChunk(String text,
                                                        String annotationText,
                                                        JavaTypeNullabilityUtil.Side side,
                                                        int position) {
