...
public class LambdaHighlightingUtil {
  ...
  @Nullable
  public static String checkInterfaceFunctional(@Nonnull PsiClass psiClass, String interfaceNonFunctionalMessage) {
  ...
  @Nullable
  public static HighlightInfo checkParametersCompatible(PsiLambdaExpression expression, PsiParameter[] methodParameters, PsiSubstitutor substitutor) {
