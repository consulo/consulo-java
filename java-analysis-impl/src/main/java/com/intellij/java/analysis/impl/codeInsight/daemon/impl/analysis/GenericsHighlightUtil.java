...
public class GenericsHighlightUtil {
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkInferredTypeArguments(
    ...
    @RequiredReadAction
    private static HighlightInfo.@Nullable Builder checkInferredTypeArguments(
        ...
        if (inferredTypeArgument != null) {
            ...
            LocalizeValue description = boundClass == null || typeParameter.isInterface() == boundClass.isInterface()
                ? JavaCompilationErrorLocalize.typeParameterInferredTypeNotWithinExtendBound(c, t1, t2)
                : JavaCompilationErrorLocalize.typeParameterInferredTypeNotWithinImplementBound(c, t1, t2);
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkParameterizedReferenceTypeArguments(
        PsiElement resolved,
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkReferenceTypeArgumentList(
            ...
            if (referenceElements.length == 1 && referenceElements[0].getType() instanceof PsiDiamondType diamondType) {
                if (!typeParameterListOwner.hasTypeParameters()) {
                    return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                        ...
                        .descriptionAndTooltip(JavaCompilationErrorLocalize.newExpressionDiamondNotApplicable());
                }
    ...
    @RequiredReadAction
    private static HighlightInfo.@Nullable Builder checkTypeParameterWithinItsBound(
        ...
        if (psiType instanceof PsiClassType && !(PsiUtil.resolveClassInType(psiType) instanceof PsiTypeParameter)
            ...
            return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                ...
                .descriptionAndTooltip(JavaCompilationErrorLocalize.typeParameterActualInferredMismatch());
        }
        ...
        for (PsiClassType type1 : bounds) {
            ...
            if (!bound.equalsToText(CommonClassNames.JAVA_LANG_OBJECT)
                ...
                LocalizeValue description = boundClass == null || referenceClass == null
                    ...
                    ? JavaCompilationErrorLocalize.typeParameterTypeNotWithinExtendBound(c, t)
                    : JavaCompilationErrorLocalize.typeParameterTypeNotWithinImplementBound(c, t);
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkElementInTypeParameterExtendsList(
        ...
        if (!extendFrom.isInterface() && referenceElements.length != 0 && element != referenceElements[0]) {
            ...
            return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                .range(element)
                .descriptionAndTooltip(JavaCompilationErrorLocalize.typeParameterCannotBeFollowedByOtherBounds())
            ...
            if (inheritedSubstitutor != null) {
                ...
                for (PsiTypeParameter typeParameter : typeParameters) {
                    ...
                    if (!Objects.equals(type1, type2)) {
                        LocalizeValue description = JavaCompilationErrorLocalize.classInheritanceDifferentTypeArguments(
    ...
    @RequiredReadAction
    public static Collection<HighlightInfo> checkOverrideEquivalentMethods(PsiClass aClass) {
    ...
    public static HighlightInfo checkDefaultMethodOverrideEquivalentToObjectNonPrivate(
        ...
        if (languageLevel.isAtLeast(LanguageLevel.JDK_1_8) && aClass.isInterface() && method.hasModifierProperty(PsiModifier.DEFAULT)) {
            ...
            for (HierarchicalMethodSignature methodSignature : sig.getSuperSignatures()) {
                ...
                if (objectMethod.getContainingClass() instanceof PsiClass containingClass
                    && CommonClassNames.JAVA_LANG_OBJECT.equals(containingClass.getQualifiedName())
                    && objectMethod.isPublic()) {
                    return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                        .range(methodIdentifier)
                        .descriptionAndTooltip(JavaCompilationErrorLocalize.methodDefaultOverridesObjectMember(sig.getName()))
                        .create();
                }
            }
        }
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkUnrelatedDefaultMethods(PsiClass aClass, PsiIdentifier classIdentifier) {
            ...
            if (!hasConcrete && defaults != null) {
                ...
                if (!aClass.isAbstract() && !(aClass instanceof PsiTypeParameter)
                    ...
                    LocalizeValue message = aClass instanceof PsiEnumConstantInitializer
                        ? JavaCompilationErrorLocalize.classMustImplementMethod(c1, m, c2)
                        : JavaCompilationErrorLocalize.classMustImplementMethodOrAbstract(c1, m, c2);
                    return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                ...
                if (isInterface || abstracts == null || unrelatedMethodContainingClass.isInterface()) {
                    ...
                    LocalizeValue description = unrelatedDefaults != null
                        ...
                        : JavaCompilationErrorLocalize.classInheritsAbstractAndDefault(
                        c,
                        m,
    ...
    private static boolean hasNotOverriddenAbstract(
        ...
        PsiClass abstractMethodContainingClass
    ) {
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkUnrelatedConcrete(PsiClass psiClass, PsiIdentifier classIdentifier) {
        ...
        if (superClass != null && superClass.hasTypeParameters()) {
            ...
            for (HierarchicalMethodSignature hms : visibleSignatures) {
                ...
                if (foundMethod != null
                    ...
                    return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                        .range(classIdentifier)
                        .descriptionAndTooltip(JavaCompilationErrorLocalize.classInheritanceMethodClash(
    ...
    @RequiredReadAction
    private static HighlightInfo.@Nullable Builder checkSameErasureNotSubSignatureInner(
    ...
    @RequiredReadAction
    private static HighlightInfo.@Nullable Builder checkSameErasureNotSubSignatureOrSameClass(
    ...
    private static HighlightInfo.Builder getSameErasureMessage(
        ...
        LocalizeValue clashMethodMessage = HighlightMethodUtil.createClashMethodMessage(method, superMethod, !sameClass);
        LocalizeValue description = sameClass
            ? JavaCompilationErrorLocalize.methodGenericSameErasure(clashMethodMessage)
            : method.isStatic()
            ? JavaCompilationErrorLocalize.methodGenericSameErasureHide(clashMethodMessage)
            : JavaCompilationErrorLocalize.methodGenericSameErasureOverride(clashMethodMessage);
        return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
            .range(textRange)
            .descriptionAndTooltip(description);
    }
    ...
    public static HighlightInfo checkTypeParameterInstantiation(PsiNewExpression expression) {
        ...
        if (element instanceof PsiTypeParameter typeParam) {
            return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                ...
                .descriptionAndTooltip(JavaCompilationErrorLocalize.newExpressionTypeParameter(HighlightUtil.formatClass(typeParam)))
                .create();
        }
        return null;
    }
            ...
            if (typeElement.getParent() instanceof PsiReferenceParameterList refParamList) {
                ...
                if (refParent instanceof PsiNewExpression newExpr) {
                    if (!(newExpr.getType() instanceof PsiArrayType)) {
                        return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                            .range(typeElement)
                            .descriptionAndTooltip(JavaCompilationErrorLocalize.typeWildcardCannotBeInstantiated(
                    ...
                    if (!(refList.getParent() instanceof PsiTypeParameter typeParam) || refList != typeParam.getExtendsList()) {
                        return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                            .range(typeElement)
                            .descriptionAndTooltip(JavaCompilationErrorLocalize.typeWildcardNotExpected())
                            .create();
                    }
                }
            }
    ...
    public static HighlightInfo.Builder checkForeachExpressionTypeIsIterable(PsiExpression expression) {
        ...
        if (itemType == null) {
            HighlightInfo.Builder hlBuilder = HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                .range(expression)
                .descriptionAndTooltip(JavaCompilationErrorLocalize.foreachNotApplicable(JavaHighlightUtil.formatType(expression.getType())));
    ...
    @RequiredReadAction
    public static HighlightInfo.Builder checkForEachParameterType(PsiForeachStatement statement, PsiParameter parameter) {
    ...
    public static HighlightInfo checkEnumInstantiation(PsiElement expression, PsiClass aClass) {
        if (aClass != null && aClass.isEnum() && (!(expression instanceof PsiNewExpression newExpr)
            ...
            return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                .range(expression)
                .descriptionAndTooltip(JavaCompilationErrorLocalize.instantiationEnum())
                .create();
        }
        return null;
    }
    ...
    public static HighlightInfo checkGenericArrayCreation(PsiElement element, PsiType type) {
        if (type instanceof PsiArrayType arrayType && !JavaGenericsUtil.isReifiableType(arrayType.getComponentType())) {
            return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                .range(element)
                .descriptionAndTooltip(JavaCompilationErrorLocalize.arrayGeneric())
                .create();
        }
        return null;
    }
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkTypeParametersList(
        ...
        if (parent instanceof PsiClass psiClass && psiClass.isEnum()) {
            return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                .range(list)
                .descriptionAndTooltip(JavaCompilationErrorLocalize.typeParameterOnEnum());
        }
        if (PsiUtil.isAnnotationMethod(parent)) {
            return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                .range(list)
                .descriptionAndTooltip(JavaCompilationErrorLocalize.typeParameterOnAnnotationMember());
        }
        if (parent instanceof PsiClass psiClass && psiClass.isAnnotationType()) {
            return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                .range(list)
                .descriptionAndTooltip(JavaCompilationErrorLocalize.typeParameterOnAnnotation());
        }
            ...
            for (int j = i + 1; j < parameters.length; j++) {
                ...
                if (Comparing.strEqual(name1, name2)) {
                    return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                        ...
                        .descriptionAndTooltip(JavaCompilationErrorLocalize.typeParameterDuplicate(name1));
                }
            }
        ...
        for (PsiTypeElement typeElement : typeElements) {
            ...
            if (aClass instanceof PsiTypeParameter) {
                result.add(HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                    .range(typeElement)
                    .descriptionAndTooltip(JavaCompilationErrorLocalize.catchTypeParameter())
                    .create());
            }
        }
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkInstanceOfGenericType(PsiInstanceOfExpression expression) {
     ...
     */
    @RequiredReadAction
    private static HighlightInfo.@Nullable Builder isIllegalForInstanceOf(PsiType type, PsiTypeElement typeElement) {
        if (PsiUtil.resolveClassInClassTypeOnly(type) instanceof PsiTypeParameter) {
            return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                .range(typeElement)
                .descriptionAndTooltip(JavaCompilationErrorLocalize.instanceofTypeParameter());
        }

        if (!JavaGenericsUtil.isReifiableType(type)) {
            return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                .range(typeElement)
                .descriptionAndTooltip(JavaCompilationErrorLocalize.instanceofIllegalGenericType());
        }
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkClassObjectAccessExpression(PsiClassObjectAccessExpression expression) {
    ...
    @RequiredReadAction
    private static HighlightInfo.@Nullable Builder canSelectFrom(PsiClassType type, PsiTypeElement operand) {
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkOverrideAnnotation(
        PsiMethod method,
        ...
        try {
            ...
            if (superMethod == null) {
                HighlightInfo.Builder hlBuilder = HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                    ...
                    .descriptionAndTooltip(JavaCompilationErrorLocalize.overrideOnNonOverridingMethod());
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkSafeVarargsAnnotation(PsiMethod method, LanguageLevel languageLevel) {
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkEnumSuperConstructorCall(PsiMethodCallExpression expr) {
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkVarArgParameterIsLast(PsiParameter parameter) {
        if (parameter.getDeclarationScope() instanceof PsiMethod method) {
            PsiParameter[] params = method.getParameterList().getParameters();
            if (params[params.length - 1] != parameter) {
                return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                    .range(parameter)
                    .descriptionAndTooltip(JavaCompilationErrorLocalize.varargNotLastParameter())
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkParametersAllowed(PsiReferenceParameterList refParamList) {
        if (refParamList.getParent() instanceof PsiReferenceExpression refExpr
            ...
            return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                .range(refParamList)
                .descriptionAndTooltip(JavaCompilationErrorLocalize.typeArgumentNotAllowed());
        }
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkParametersOnRaw(PsiReferenceParameterList refParamList) {
        ...
        if (resolveResult != null) {
            ...
            if (containingClass != null && PsiUtil.isRawSubstitutor(containingClass, resolveResult.getSubstitutor())) {
                ...
                LocalizeValue message = element instanceof PsiClass
                    ? JavaCompilationErrorLocalize.typeArgumentOnRawType()
                    : JavaCompilationErrorLocalize.typeArgumentOnRawMethod();
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkCannotInheritFromEnum(PsiClass superClass, PsiElement elementToHighlight) {
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkGenericCannotExtendException(PsiReferenceList list) {
        PsiElement parent = list.getParent();
        ...
        for (PsiJavaCodeReferenceElement referenceElement : referenceElements) {
            ...
            if (InheritanceUtil.isInheritorOrSelf(psiClass, throwableClass, true)) {
                ...
                return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                    ...
                    .descriptionAndTooltip(JavaCompilationErrorLocalize.classGenericExtendsException())
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkEnumWithoutConstantsCantHaveAbstractMethods(PsiClass aClass) {
        if (!aClass.isEnum()) {
            return null;
        }
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkSelectStaticClassFromParameterizedType(PsiElement resolved, PsiJavaCodeReferenceElement ref) {
    ...
    public static HighlightInfo.Builder checkCannotInheritFromTypeParameter(PsiClass superClass, PsiJavaCodeReferenceElement toHighlight) {
        if (superClass instanceof PsiTypeParameter) {
            return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                .range(toHighlight)
                .descriptionAndTooltip(JavaCompilationErrorLocalize.classInheritsTypeParameter());
        }
        return null;
    }
     ...
     */
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkRawOnParameterizedType(PsiJavaCodeReferenceElement parent, PsiElement resolved) {
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder checkCannotPassInner(PsiJavaCodeReferenceElement ref) {
        ...
        for (Map.Entry<PsiTypeParameter, PsiType> typeEntry : substitutor.getSubstitutionMap().entrySet()) {
            ...
            if (typeEntry.getValue() instanceof PsiIntersectionType intersectionType) {
                ...
                if (conflictingConjunctsMessage != null) {
                    return HighlightInfo.newHighlightInfo(HighlightInfoType.ERROR)
                        .descriptionAndTooltip(
                            JavaCompilationErrorLocalize.typeParameterIncompatibleUpperBounds(parameterName, conflictingConjunctsMessage)
                        )
                        .range(ref);
                }
            }
    ...
    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder areSupersAccessible(PsiClass aClass) {
        return areSupersAccessible(aClass, aClass.getResolveScope(), HighlightNamesUtil.getClassDeclarationTextRange(aClass), true);
    }

    @RequiredReadAction
    public static HighlightInfo.@Nullable Builder areSupersAccessible(PsiClass aClass, PsiReferenceExpression ref) {
    ...
    @RequiredReadAction
    private static LocalizeValue isSuperTypeAccessible(
        PsiType superType,
        ...
        if (aClass != null && classes.add(aClass)) {
            ...
            if (qualifiedName != null && factory.findClass(qualifiedName, resolveScope) == null) {
                return JavaCompilationErrorLocalize.classNotAccessible(HighlightUtil.formatClass(aClass));
            }
