...
class StateMerger {
  ...
  @Nonnull
  private MultiMap<Fact, DfaMemoryStateImpl> createFactToStateMap(@Nonnull List<DfaMemoryStateImpl> states) {
  ...
  @Nonnull
  private MultiMap<CompactFactSet, DfaMemoryStateImpl> mapByUnrelatedFacts(@Nonnull Fact fact,
  ...
  @Nonnull
  private CompactFactSet getUnrelatedFacts(@Nonnull final Fact fact,
  ...
  private void restoreOtherInequalities(@Nonnull EqualityFact removedFact,
                                        @Nonnull Collection<DfaMemoryStateImpl> mergedGroup,
                                        @Nonnull DfaMemoryStateImpl state) {
  ...
  @Nonnull
  private static Set<DfaConstValue> getOtherInequalities(@Nonnull EqualityFact removedFact,
                                                         @Nonnull Set<Fact> memberFacts,
                                                         @Nonnull DfaMemoryStateImpl state) {
  ...
  static abstract class Fact {
    ...
    abstract boolean invalidatesFact(@Nonnull Fact another);

    abstract void removeFromState(@Nonnull DfaMemoryStateImpl state);

    @Nonnull
    static EqualityFact createEqualityFact(@Nonnull DfaVariableValue var, @Nonnull DfaValue val) {
  ...
  static final class InstanceofFact extends Fact {
    ...
    private InstanceofFact(@Nonnull DfaVariableValue var, boolean positive, @Nonnull DfaPsiType type) {
  ...
  private static class Replacements {
    ...
    private void stripAndMerge(@Nonnull Collection<DfaMemoryStateImpl> group,
                               @Nonnull Function<DfaMemoryStateImpl, DfaMemoryStateImpl> stripper) {
