...
public class DfaFactMapValue extends DfaValue
{
	...
	public <T> DfaValue withFact(@Nonnull DfaFactType<T> factType, @Nullable T value)
	{
	...
	@Nullable
	public <T> T get(@Nonnull DfaFactType<T> factType)
	{
	...
	public static class Factory
	{
		...
		public <T> DfaValue createValue(@Nonnull DfaFactType<T> factType, @Nullable T value)
		{
