...
public class StandardInstructionVisitor extends InstructionVisitor
{
												...
												PsiExpression rValue)
	{
		...
		if(sourceType == null || TypeConversionUtil.areTypesConvertible(sourceType, componentType))
			return;
	...
	@Nullable
	private static PsiType getType(@Nullable PsiExpression expression, @Nullable DfaValue value, @Nonnull DfaMemoryState memState)
	{
	...
	protected void beforeMethodCall(@Nonnull PsiExpression expression,
