...
public abstract class DataFlowInspectionBase extends AbstractBaseJavaLocalInspectionTool
{
	...
	public
	@Nonnull
	PsiElementVisitor buildVisitor(@Nonnull ProblemsHolder holder, boolean isOnTheFly)
	{
	...
	protected
	@Nonnull
	List<LocalQuickFix> createNPEFixes(PsiExpression qualifier, PsiExpression expression, boolean onTheFly)
	{
		return Collections.emptyList();
	}
