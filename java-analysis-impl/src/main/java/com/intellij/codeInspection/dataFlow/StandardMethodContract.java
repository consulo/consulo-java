...
public final class StandardMethodContract extends MethodContract
{
	...
	public boolean equals(Object o)
	{
		...
		if(!Arrays.equals(arguments, contract.arguments))
		{
			return false;
		}
		if(returnValue != contract.returnValue)
		{
			return false;
		}
	...
	{
		return IntStreamEx.ofIndices(arguments).mapToObj(idx -> arguments[idx].getCondition(idx)).without(ContractValue.booleanValue(true)).toList();
	}
