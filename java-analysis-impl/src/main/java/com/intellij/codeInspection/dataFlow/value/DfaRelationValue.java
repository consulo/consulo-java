...
public class DfaRelationValue extends DfaValue
{
	...
	private DfaRelationValue(DfaValue leftOperand, DfaValue rightOperand, RelationType relationType, DfaValueFactory factory)
	{
		super(factory);
	...
	public static class Factory
	{
		...
		public DfaRelationValue createRelation(DfaValue dfaLeft, RelationType relationType, DfaValue dfaRight)
		{
			...
			if(dfaLeft instanceof DfaVariableValue || dfaLeft instanceof DfaBoxedValue || dfaLeft instanceof DfaUnboxedValue || dfaRight instanceof DfaVariableValue || dfaRight instanceof
					DfaBoxedValue || dfaRight instanceof DfaUnboxedValue)
			{
